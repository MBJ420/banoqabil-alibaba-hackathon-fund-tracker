...
import { LineChart, TrendingUp, Scale, BadgeCheck, Info, HelpCircle } from 'lucide-react';
import { useToast } from '../components/Toast';
import FeatureInfoModal, { type FeatureGuideContent } from '../components/FeatureInfoModal';

const BENCHMARK_GUIDE: FeatureGuideContent = {
  title: 'Benchmark Alpha & Fee Analyzer',
  subtitle: 'Measuring manager performance vs KSE-100 / KMI-30 and quantifying AMC fee drag',
  badge: 'Alpha & Fee Drag Model',
  overview: 'This analyzer measures whether your mutual fund is actually beating the Pakistan Stock Exchange benchmark (KSE-100 or KMI-30 Islamic) after deducting the asset manager\'s Total Expense Ratio (TER). It reveals whether you are getting real value or paying active fees for underperformance.',
  howToUse: [
    'Check your Fund Expense Ratio (TER %) — Asset Management Companies in Pakistan typically charge between 1.5% and 3.5% annually.',
    'Compare returns across standard horizons: 1 Month, 6 Months, 1 Year, and 3 Years.',
    'Review the Net Alpha metric: A positive green Alpha means the manager beat the index even after taking their fee.',
    'Check the Value Rating Badge ("Great Value", "Fair Value", or "Overpriced").'
  ],
  mathExplanation: [
    {
      formulaName: 'Jensen\'s Gross Alpha',
      formula: 'Gross_Alpha = Fund_Return - Benchmark_Return',
      description: 'The excess return generated by the fund manager above the market index.'
    },
    {
      formulaName: 'Net Alpha (Fee Drag Deduction)',
      formula: 'Net_Alpha = Gross_Alpha - Total_Expense_Ratio (TER)',
      description: 'The real value added to your pocket after subtracting the management company\'s operational fees.'
    },
    {
      formulaName: 'Value Classification',
      formula: 'Rating = (Net_Alpha > 0) ? "Great Value" : (Net_Alpha > -TER ? "Fair Value" : "Overpriced")',
      description: 'Categorizes whether the fund manager justified their annual management fees.'
    }
  ],
  proTips: [
    'Fee Drag Compounding: A 3% annual fee might sound small, but over a 10-year period, it can consume up to 25% of your total compound returns.',
    'Index-Tracking Funds: If an active fund consistently generates negative Alpha, you may be better off in a low-cost index tracking fund or Islamic income fund.'
  ],
  disclaimer: 'Benchmark figures are representative historical index baselines for simulation. Past performance is no guarantee of future market results.'
};
      ...
      <div className="p-8 max-w-5xl mx-auto space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-sky-500 to-sky-700 flex items-center justify-center shadow-sky-500/20 shrink-0">
