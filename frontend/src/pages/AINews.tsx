...
const AI_NEWS_GUIDE: FeatureGuideContent = {
  ...
  subtitle: 'How Qwen 2.5 (Alibaba Cloud) extracts macro insights from Dawn & Business Recorder for mutual fund categories',
  badge: 'Qwen 2.5 Macro Pipeline',
  ...
  howToUse: [
    ...
    'Click on any asset card (e.g. PSX Stocks or Gold) to expand Qwen\'s detailed reasoning.',
      ...
      <div className="max-w-5xl mx-auto space-y-6">
              ...
              <>
                {worldContext.length === 0 ? (
                  <div className="text-center py-10">
                    ...
                    <p className="text-text-secondary text-xs mt-1">Qwen will populate this after the first AI analysis run.</p>
                  </div>
                ) : (
                  <div className="space-y-3">
        ...
        {!loading && (
          <div className="flex items-start gap-3 px-4 py-3 bg-white/3 border border-white/5 rounded-xl text-xs text-text-secondary">
            ...
            <p>
              Analysis is generated by <strong className="text-text-primary">Qwen 2.5 (Alibaba Cloud Model Studio)</strong> using a 2-pass pipeline:
