...
const AI_NEWS_GUIDE: FeatureGuideContent = {
  title: 'FundTracker AI Market Intelligence',
  subtitle: 'How FundTracker AI, powered by Qwen extracts macro insights from Dawn & Business Recorder for mutual fund categories',
  badge: 'FundTracker AI (Powered by Qwen)',
  ...
  howToUse: [
    ...
    'Click on any asset card (e.g. PSX Stocks or Gold) to expand FundTracker AI\'s detailed reasoning.',
      ...
      <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div>
            <div className="flex items-center gap-3 flex-wrap">
              <h2 className="text-2xl font-bold tracking-tight flex items-center gap-2">
                ...
                FundTracker AI Market Analysis
              </h2>
            ...
            <p className="text-text-secondary text-sm mt-1">
              Powered by FundTracker AI (Qwen 2.5) · {predictions?.generated_at ? `Analyzed ${timeAgo(predictions.generated_at)}` : 'No analysis yet'}
            </p>
          </div>
        ...
        {refreshing && (
          <div className="flex items-center gap-3 px-4 py-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-emerald-500 text-sm">
            ...
            <span>FundTracker AI, powered by Qwen is analyzing today's news. Running 2-pass AI pipeline… This takes 15–30 seconds.</span>
          </div>
        )}
              ...
              <>
                {worldContext.length === 0 ? (
                  <div className="text-center py-10">
                    ...
                    <p className="text-text-secondary text-xs mt-1">FundTracker AI will populate this after the first AI analysis run.</p>
                  </div>
                ) : (
                  <div className="space-y-3">
        ...
        {!loading && (
          <div className="flex items-start gap-3 px-4 py-3 bg-white/3 border border-white/5 rounded-xl text-xs text-text-secondary">
            ...
            <p>
              Analysis is generated by <strong className="text-text-primary">FundTracker AI, powered by Qwen (Alibaba Cloud Model Studio)</strong> using a 2-pass pipeline:
