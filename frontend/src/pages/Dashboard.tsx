...
import { LogOut, LayoutDashboard, Database, TrendingUp, Zap, ArrowUpRight, ArrowDownRight, Activity, Menu, Building2, Download, FileText, Sun, Moon, Calculator, Info, Search, UploadCloud, ChevronDown, ChevronUp, Filter, Newspaper, Brain, Lightbulb, PiggyBank } from 'lucide-react';
    ...
    return (
        <div className="flex h-screen bg-midnight text-text-primary overflow-hidden font-sans selection:bg-emerald-500 selection:text-text-primary">
            ...
            <main className="flex-1 flex flex-col overflow-hidden relative">
                ...
                {currentPage === '/simulator' && <InflationSimulator />}
